...
class acfe_pro_field_fc_iframe{
    ...
    function wrapper_attributes($wrapper, $field){
        ...
        // responsive
        if(!acfe_get($field, 'acfe_flexible_layouts_previews_responsive')){
            return $wrapper;
        }
    ...
    function render_field($field){
        ...
        // check setting
        if(!acfe_get($field, 'acfe_flexible_layouts_templates') || !acfe_get($field, 'acfe_flexible_layouts_previews') || !acfe_get($field, 'acfe_flexible_layouts_previews_iframe')){
    ...
    function before_template($field, $layout, $is_preview){
        ...
        // validate
        if(!$is_preview || !acfe_get($field, 'acfe_flexible_layouts_previews_iframe')){
            return;
        }
