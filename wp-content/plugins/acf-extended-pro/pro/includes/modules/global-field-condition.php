...
class acfe_pro_global_field_condition{
    ...
    function get_any_fields(&$fields, $field){
        ...
        // vars
        $sub_fields = acfe_get($field, 'sub_fields');
        $layouts = acfe_get($field, 'layouts');
        ...
        if($layouts){
            ...
            foreach($layouts as $layout){
                ...
                $sub_fields = acfe_get($layout, 'sub_fields');
    ...
    function get_fields(){
        ...
        foreach($fields as $field){
            ...
            if(acfe_get($field, 'acfe_field_group_condition')){
                $valid_fields[] = $field;
            }
    ...
    function load_fields($fields, $parent){
        ...
        if(!acf_is_field_group_key(acfe_get($parent, 'key'))){
            return $fields;
        }
