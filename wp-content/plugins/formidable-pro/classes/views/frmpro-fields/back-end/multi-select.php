...
?>
<p id="frm_multiple_cont_<?php echo absint( $field['id'] ); ?>" class="frm_form_field frm_multiple_cont_<?php echo absint( $field['id'] ); ?> <?php echo $field['type'] === 'data' && ( ! isset( $field['data_type'] ) || $field['data_type'] !== 'select' ) ? 'frm_hidden' : ''; ?>">
