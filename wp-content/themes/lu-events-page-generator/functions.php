...
function lu_generator_enqueue_assets(): void {
	...
	wp_enqueue_style( 'lu-generator', get_template_directory_uri() . '/assets/css/generator.css', array( 'dashicons' ), '0.2.0' );
	wp_enqueue_script( 'lu-generator', get_template_directory_uri() . '/assets/js/generator.js', array(), '0.2.0', true );
