...
class acfe_location_post_date_time extends acfe_pro_location{
    ...
    function rule_values($choices, $rule){
        return $this->get_rule_value_input($rule, 'date_time_picker');
    }
    ...
    function format_rule_value($rule){
        return acf_format_date($rule['value'], 'd/m/Y H:i:s');
    }
