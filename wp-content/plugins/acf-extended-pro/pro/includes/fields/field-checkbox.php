...
class acfe_pro_field_checkbox extends acfe_field_extend{
    ...
    function render_field($field){
        ...
        // ensure array
        $field['value'] = acfe_as_array($field['value']);
        $field['choices'] = acfe_as_array($field['choices']);
    ...
    function render_field_custom($field){
        ...
        // back-compatibility
        if(empty($field['custom_choice_button_text'])){
            $field['custom_choice_button_text'] = __('Add Custom', 'acf');
        }
