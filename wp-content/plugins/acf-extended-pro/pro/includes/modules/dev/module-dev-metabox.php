...
class acfe_pro_dev_metabox{
    ...
    function post_submitbox_misc_actions($post){
        ...
        add_action('admin_footer', function() use($post){
            ...
            ?>
            <div class="acfe-modal" data-modal="acfe-wp-object" data-width="550" data-title="<?php _e('Post Object', 'acfe'); ?>" data-footer="<?php _e('Close', 'acfe'); ?>">
    ...
    function term_submitbox_misc_actions($term){
        ...
        <div id="misc-publishing-actions" style="border-bottom:1px solid #dcdcde;">
            ...
            <div class="acfe-modal" data-modal="acfe-wp-object" data-width="550" data-title="<?php _e('Term Object', 'acfe'); ?>" data-footer="<?php _e('Close', 'acfe'); ?>">
                <div class="acfe-modal-spacer">
    ...
    function user_submitbox_misc_actions($user){
        ...
        <div id="misc-publishing-actions" style="border-bottom:1px solid #dcdcde;">
            ...
            <div class="acfe-modal" data-modal="acfe-wp-object" data-width="550" data-title="<?php _e('User Object', 'acfe'); ?>" data-footer="<?php _e('Close', 'acfe'); ?>">
                <div class="acfe-modal-spacer">
    ...
    function options_page_submitbox_misc_actions($page){
        ...
        // vars
        $post_id = acfe_get($page, 'post_id', false);
        $acf_post_id = acf_get_valid_post_id($post_id);
