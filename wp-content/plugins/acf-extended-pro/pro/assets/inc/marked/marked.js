    ...
    var Pe = (l, e) => {
        ...
        Se = (l, e, t, n) => {
            if (e && typeof e == "object" || typeof e == "function")
                for (let s of we(e)) !ye.call(l, s) && s !== t && N(l, s, {
                    get: () => e[s],
...
` ? t[1].slice(0, -1) : t[1];
        ...
        emStrong(e, t, n = "") {
            ...
            if (!(s[1] || s[3] || "") || !n || this.rules.inline.punctuation.exec(n)) {
                ...
                for (p.lastIndex = 0, t = t.slice(-1 * e.length + i);
                    (s = p.exec(t)) !== null;) {
        ...
        del(e, t, n = "") {
            ...
            if (!(s[1] || "") || !n || this.rules.inline.punctuation.exec(n)) {
                ...
                for (c.lastIndex = 0, t = t.slice(-1 * e.length + i);
                    (s = c.exec(t)) !== null;) {
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = o.text) : t.push(r);
        ...
        inlineTokens(e, t = []) {
            ...
            if (this.tokens.links) {
                ...
                if (a.length > 0)
                    for (;
                        (s = this.tokenizer.rules.inline.reflinkSearch.exec(n)) !== null;) a.includes(s[0].slice(s[0].lastIndexOf("[") + 1, -1)) && (n = n.slice(0, s.index) + "[" + "a".repeat(s[0].length - 2) + "]" + n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            for (;
            ...
            let r;
            for (;
                (s = this.tokenizer.rules.inline.blockSkip.exec(n)) !== null;) r = s[2] ? s[2].length : 0, n = n.slice(0, s.index + r) + "[" + "a".repeat(s[0].length - r - 2) + "]" + n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
