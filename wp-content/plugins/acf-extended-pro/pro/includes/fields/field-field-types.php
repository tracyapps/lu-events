...
class acfe_field_types extends acfe_field{
    ...
    function get_choices($field){
        ...
        // get field types
        $choices = $this->get_pretty_field_types($field['field_types']);
        
        // group by category
        if(!$field['categories']){
            return acfe_array_flatten($choices, true);
        }
    ...
    function render_field_settings($field){
        ...
        // Group by Category
        acf_render_field_setting($field, array(
            'label'         => __('Group by category', 'acfe'),
            'instructions'  => __('Group field types by their category', 'acfe'),
            'name'          => 'categories',
            'type'          => 'true_false',
            'ui'            => 1,
        ));
    ...
    function prepare_field($field){
        ...
        // labels
        $field = acfe_prepare_choices_label($field);
    ...
    function validate_front_value($valid, $value, $field, $input, $form){
        ...
        $choices = acfe_array_flatten($choices, true);
