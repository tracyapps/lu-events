...
class acfe_pro_admin_settings{
    ...
    function register_fields(){
        ...
        $this->fields['modules'][] = array(
            'label'         => 'UI Enhancements: Field Group',
        ...
        $this->fields['modules'][] = array(
            'label'         => 'UI Enhancements: Post',
            'name'          => 'acfe/modules/post_ui',
            'description'   => 'Show/hide the Post UI enhancements module. Defaults to true',
            'type'          => 'true_false',
            'category'      => 'modules',
        );
