...
class acfe_module_sync_ajax_diff extends ACF_Ajax{
    ...
    function get_response($request){
        ...
        // get db item
        $db_item = $module->get_item($id, 'db');
        
        if($db_item){
    
            // prepare item
            $db_item['modified'] = get_post_modified_time('U', true, $db_item['ID']);
            $db_item             = $module->prepare_item_for_export($db_item);
    ...
    function get_date($modified){
        ...
        if(is_array($modified)){
            $modified = acfe_get($modified, 'modified');
        }
