...
class acfe_fields_field extends acfe_field{
    ...
    function get_choices($field){
        ...
        // get field types
        $choices = $this->get_pretty_fields($field['fields']);
    ...
    function render_field_settings($field){
        ...
        acf_render_field_setting($field, array(
            'label'         => __('Group by field group', 'acfe'),
            'instructions'  => __('Group fields by their field group', 'acfe'),
            'name'          => 'field_groups',
            'type'          => 'true_false',
            'ui'            => 1,
        ));
