...
if(!class_exists('acfe_pro_field_google_map')):

class acfe_pro_field_google_map extends acfe_field_extend{
    ...
    function field_wrapper_attributes($wrapper, $field){
        ...
        // View: Disable Fullscreen
        if(acfe_get($field, 'acfe_google_map_disable_fullscreen')){
        ...
        // Value: Zoom
        $value_zoom = acfe_get($value, 'zoom');
    ...
    function format_value($value, $post_id, $field){
        ...
        $value['zoom'] = (int) acfe_get($value, 'zoom', $field['acfe_google_map_zooms']['zoom']);
        $value['marker']   = false;
    ...
    function prepare_zoom($field){
        ...
        // check setting
        if(acfe_get($field['wrapper'], 'data-setting') === 'google_map'){
...
acf_new_instance('acfe_pro_field_google_map');
