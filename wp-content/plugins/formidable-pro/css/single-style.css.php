...
.<?php echo esc_html( $settings['style_class'] ); ?> .chosen-container-single .chosen-single abbr{
	top:<?php echo esc_html( 6 + (int) $top_margin ); ?>px <?php esc_html( $important ); ?>;
}
...
.<?php echo esc_html( $settings['style_class'] ); ?> .frm-datepicker:not(.frm-datepicker-custom-theme) .flatpickr-day,
.<?php echo esc_html( $settings['style_class'] ); ?>.frm-datepicker:not(.frm-datepicker-custom-theme) .flatpickr-day,
...
.<?php echo esc_html( $settings['style_class'] ); ?> td.ui-datepicker-today:not(.ui-datepicker-current-day) {
	background-color: transparent !important;
}
.<?php echo esc_html( $settings['style_class'] ); ?> .frm-datepicker:not(.frm-datepicker-custom-theme) .flatpickr-day.today:not(.inRange):not(.selected):not(.startRange):not(.endRange),
.<?php echo esc_html( $settings['style_class'] ); ?>.frm-datepicker:not(.frm-datepicker-custom-theme) .flatpickr-day.today:not(.inRange):not(.selected):not(.startRange):not(.endRange) {
	color: var(--date-band-color)<?php echo esc_html( $important ); ?>;
	font-weight: 600;
}
	<?php // Target .ui-state-default rather than > a, so today keeps the highlight color when it is unselectable and rendered as a span. ?>
.<?php echo esc_html( $settings['style_class'] ); ?> td.ui-datepicker-today:not(.ui-datepicker-current-day) > .ui-state-default {
	color: var(--date-band-color)<?php echo esc_html( $important ); ?>;
	font-weight: 600;
}
